// TrueState Move-In service worker — caches the app shell so it launches
// instantly. Live video/signalling always go to network.
const CACHE = 'truestate-movein-v1';
