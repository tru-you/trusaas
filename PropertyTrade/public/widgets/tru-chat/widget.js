 ...
 * (TRUPROPERTY_TRUCHAT_CONFIG). No dealer-specific
...
(function () {
  ...
  function boot() {
    ...
    var CFG = window.TRUPROPERTY_TRUCHAT_CONFIG || null;
    if (!CFG) {
    ...
    tip.id = "tc-tip";
    tip.innerHTML = "Chat with <strong>" + esc(assistantName) + "</strong> — stock, finance & budgets";
