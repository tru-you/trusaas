...
export default function buyerRoutes(dataDir) {
  ...
  r.post('/api/buyers', requireRole('admin','principal','manager'), (req, res) => {
    ...
    recordAudit(dataDir, { agentId: req.agentId, agencyId: req.agencyId, action: 'create', entityType: 'buyer', entityId: id });
  ...
  r.put('/api/buyers/:id', requireRole('admin','principal','manager'), (req, res) => {
    ...
    recordAudit(dataDir, { agentId: req.agentId, agencyId: req.agencyId, action: 'update', entityType: 'buyer', entityId: existing.id });
    res.json(existing);
  });
