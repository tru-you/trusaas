 ...
 */
import type { DMSState, Enquiry, User, Dealership } from "./src/types";
...
// State persistence (readState/writeState, per-dealer files, seed/backfills,
...
// Dealer Documents API — GET/POST /api/documents, sign/void/delete/finalize,
...
app.use(documentRoutes({ readState, writeState, scopeToDealer, mayTouch, newId }));
...
// dealership self-service settings endpoint.
