          ...
          <table className="w-full border-collapse mb-6 text-[13px] text-[color:var(--tru-ink-700)]">
            <thead>
              <tr className="border-b-2 border-[color:var(--tru-ink-900)]/12 bg-[color:var(--tru-paper)]">
                <th className="text-left py-2 px-3 font-semibold text-[color:var(--tru-ink-700)] text-[13px]">Property</th>
            ...
            <tbody>
              <tr className="border-b border-[color:var(--tru-ink-900)]/8">
                <td className="py-3 px-3">
                  {property ? (
                    <>
                      <div className="font-semibold text-[color:var(--tru-ink-900)]">{property.address} {property.suburb}</div>
                      <div className="text-[13px] text-[color:var(--tru-ink-300)]">Type: {property.propertyType} / Erf: {property.erfRef || '—'} / Floor: {property.floorSize || '—'} m²</div>
                    </>
                  ) : (
                    <div className="font-semibold">Standard Property Asset Purchase</div>
                  )}
                </td>
