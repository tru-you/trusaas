...
const PRODUCT_OPTIONS: Array<{ id: string; label: string; hint: string }> = [
  ...
  { id: "flow", label: "TruFlow", hint: "The DMS — stock, enquiries, invoicing" },
  { id: "flow-lite", label: "TruFlow Light", hint: "Lightweight dealer console — enquiries, inventory & upload" },
