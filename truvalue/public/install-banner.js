 ...
 *   window.TRU_INSTALL = { appName: 'TruLive', accent: '#4D9BFF', key: 'trulive_pwa' }
 */
(function () {
  var cfg = window.TRU_INSTALL || {};
  var APP = cfg.appName || 'this app';
  var ACCENT = cfg.accent || '#4FE3DC';
  ...
  function render() {
    ...
    var steps = iosHelp
      ? '<ol style="margin:8px 0 0;padding-left:18px;color:rgba(232,234,230,.72);font-size:12px;line-height:1.7">' +
    ...
    el.innerHTML =
      '<div style="max-width:380px;margin:0 auto;background:#0B0F17;border:1px solid ' + ACCENT + '40;' +
      'border-radius:18px;padding:14px;box-shadow:0 24px 60px -30px rgba(0,0,0,.9)">' +
        '<div style="font-size:13px;font-weight:600;color:#E8EAE6">Install ' + APP + '</div>' +
        '<div style="font-size:12px;color:rgba(232,234,230,.55);margin-top:2px;line-height:1.45">' +
          (isIosSafari()
        ...
        '<div style="display:flex;gap:8px;margin-top:12px">' +
          ...
          'background:' + ACCENT + ';color:#06080D;font-size:12px;font-weight:600;cursor:pointer">' + label + '</button>' +
          '<button id="tru-install-x" aria-label="Dismiss" style="border:1px solid rgba(232,234,230,.16);' +
          'background:transparent;border-radius:999px;padding:9px 14px;color:rgba(232,234,230,.55);' +
