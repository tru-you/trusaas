/* MKR Glass — rebuilds the topbar with a live trading-hours status.
...
(function () {
  ...
  function build() {
    ...
    var s = status();
    bar.innerHTML =
      '<span class="tb-loc">' + PIN + "495 Cape Road, Westering &middot; <b>Gqeberha</b></span>"
      + '<span class="tb-status ' + (s.open ? "open" : "shut") + '" id="tbStatus" aria-live="polite">'
      + "<i></i>" + s.text + "</span>"
      + '<a class="tb-phone" href="tel:+27662912809">' + TEL + "+27 66 291 2809</a>";
