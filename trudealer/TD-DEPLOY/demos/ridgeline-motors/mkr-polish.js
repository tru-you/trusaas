/* Ridgeline Polish — ribbons, quick-view, skeletons, reviews strip, delivered ticker, mobile bar
...
function decorate(){
  ...
  cards.forEach(function(card, i){
    ...
    // Status comes from the DMS via data-status (set in Ridgeline.dataAttrs). No data,
...
var REVIEWS = [
  ...
  {n:"Riaan B.", car:"Navara PRO-2X", txt:"Straight-up dealership. The 360 view and damage tags meant zero surprises. Best buying experience I've had — and I've bought a lot of trucks."}
];
function reviewsStrip(){
  ...
  sec.innerHTML =
    ...
    +'<div class="mkr-rev-badge"><img src="demo-logo.svg" alt="" style="width:20px;height:20px;border-radius:6px;object-fit:cover">Verified buyers &middot; Austin &amp; nationwide</div>'
    +'</div>'
...
/* ===== DELIVERED TICKER ===== */
var DELIVERIES = [
  {car:"Toyota Fortuner 2.8 GD-6", to:"San Antonio", when:"this week"},
  {car:"VW Golf 8 GTI", to:"Houston", when:"3 days ago"},
  {car:"Ford Ranger Wildtrak", to:"East London", when:"this week"},
  {car:"Hyundai Tucson Premium", to:"Bloemfontein", when:"last week"},
  {car:"BMW M2 Coupé", to:"Fort Worth", when:"this week"}
];
function ticker(){
...
/* Keep the optional launchers off the hero on phones.
   ...
   bar outright and the rail sat over the CTA row, so the hero's Text button
