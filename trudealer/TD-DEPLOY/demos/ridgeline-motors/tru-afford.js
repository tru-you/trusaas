 ...
 * Drop-in: <script src="tru-afford.js" data-dealer="Your Car Guy" data-wa="+1 512 555 0142" data-brand="ycg"></script>
...
(function () {
  ...
  var cfg = {
    ...
    wa: (scr && scr.getAttribute("data-wa")) || "+1 512 555 0142",
    ...
    offsetBottom: (scr && scr.getAttribute("data-bottom")) || "88px", // clear Text FAB
  ...
  function render() {
    ...
    if (state.step === 1) {
      html =
        ...
        '<p class="ta-p">A soft affordability estimate for ' + cfg.dealer + " — no hard bureau pull, no score damage claim. Instant range, then Text the team.</p>" +
        '<div class="ta-soft">' +
      ...
      html =
        ...
        '<button type="button" class="ta-btn ta-btn-wa" id="ta-wa">Text result</button>' +
        "</div>" +
