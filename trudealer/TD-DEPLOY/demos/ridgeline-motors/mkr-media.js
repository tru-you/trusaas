/* Ridgeline Media — real 360 frame-spin and walkaround video in the vehicle modal.
 *
...
(function () {
  ...
  function enhance(car) {
    ...
    if (stage.getAttribute("data-mkr-media") === "1") return;
    stage.setAttribute("data-mkr-media", "1");
  ...
  window.RidgelineMedia = { mediaOf: mediaOf };
})();
