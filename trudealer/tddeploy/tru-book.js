...
(function (root) {
  ...
  /* TruDealer marketing site — booking a software demo, not a car visit. */
  var MODES = {
    walkthrough: {
      label: "Live walkthrough",
      title: "Book a live walkthrough",
      sub: "25 minutes on a screen-share. We run your actual stock through the full stack — website, TruChat, inspections, pipeline. No slides, no hard sell.",
      dur: 25,
      ev: "TruDealer walkthrough — " + cfg.dealer,
      loc: cfg.address
    },
    onboarding: {
      label: "Onboarding & setup",
      title: "Book onboarding & setup",
      sub: "Ready to go live? We set up your branded site, import your stock, and configure TruChat with you — start to finish.",
      dur: 45,
      ev: "TruDealer onboarding — " + cfg.dealer,
      loc: cfg.address
    },
    migrate: {
      label: "Switch my DMS",
      title: "Switch from your current DMS",
      sub: "See how we migrate you off your current system — stock, leads, and website — usually inside a week, with no downtime.",
      dur: 30,
      ev: "TruDealer migration chat — " + cfg.dealer,
      loc: cfg.address
    }
  };
  ...
  var bg = null, slots = [], selDay = 0, selTime = "", mode = "walkthrough", car = null;
  ...
  function confirm() {
    ...
    // Send CRM Webhook to TruFlow DMS integration endpoint
  ...
  function open(opts) {
    ...
    slots = buildSlots();
    selDay = 0;
    mode = MODES[opts.mode] ? opts.mode : "walkthrough";
    car = opts.car || null;
    paint();
