...
const CFG = {
  ...
  stockApi:      process.env.STOCK_API || 'https://premium.trudealers.com/api/public/stock?dealer=true-cars',
  stockApiFallback: process.env.STOCK_API_FALLBACK || 'https://premium.trudealers.com/api/public/stock?dealer=demo',
