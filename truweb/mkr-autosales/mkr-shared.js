...
const MKR = (() => {
  ...
  const MOCK = [
    {y:2023,make:"Nissan",name:"Navara 2.5DDTi PRO-2X",variant:"Double Cab 4×4 Auto",body:"bakkie",cat:"performance",km:"42 846 km",tr:"Auto",fuel:"Diesel",price:529900,tag:"Premium Performance",vir:"4.8",img:"https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&w=1000&q=80"},
    {y:2021,make:"Volkswagen",name:"Golf 8 GTI",variant:"DSG · Performance pack",body:"hatch",cat:"performance",km:"38 200 km",tr:"DSG",fuel:"Petrol",price:489900,tag:"Premium Performance",vir:"4.7",img:"https://images.unsplash.com/photo-1617531653332-bd46c24f2068?auto=format&fit=crop&w=1000&q=80"},
    {y:2018,make:"BMW",name:"M2 Coupé",variant:"Manual · Long Beach Blue",body:"coupe",cat:"performance",km:"64 000 km",tr:"Manual",fuel:"Petrol",price:589900,tag:"Premium Performance",vir:"4.6",img:"https://images.unsplash.com/photo-1555215695-3004980ad54e?auto=format&fit=crop&w=1000&q=80"},
    {y:2019,make:"Audi",name:"RS3 Sportback",variant:"Quattro · Sports exhaust",body:"hatch",cat:"performance",km:"58 500 km",tr:"S-Tronic",fuel:"Petrol",price:549900,tag:"Premium Performance",vir:"4.7",img:"https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?auto=format&fit=crop&w=1000&q=80"},
    {y:2012,make:"MINI",name:"Cooper S Hatch",variant:"Manual · Character",body:"hatch",cat:"performance",km:"174 187 km",tr:"Manual",fuel:"Petrol",price:139900,tag:"Premium Performance",vir:"4.3",img:"https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&w=1000&q=80"},
    {y:2019,make:"Hyundai",name:"Tucson 2.0 Premium",variant:"Auto · Full history",body:"suv",cat:"select",km:"33 711 km",tr:"Auto",fuel:"Petrol",price:259900,tag:"Premium Select",vir:"4.7",img:"https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?auto=format&fit=crop&w=1000&q=80"},
    {y:2026,make:"Volkswagen",name:"Polo Vivo 1.4 Life",variant:"Hatch · Like new",body:"hatch",cat:"select",km:"3 736 km",tr:"Manual",fuel:"Petrol",price:279900,tag:"Premium Select",vir:"4.9",img:"https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?auto=format&fit=crop&w=1000&q=80"},
    {y:2022,make:"Toyota",name:"Fortuner 2.8 GD-6",variant:"4×4 Epic Auto",body:"suv",cat:"select",km:"48 000 km",tr:"Auto",fuel:"Diesel",price:569900,tag:"Premium Select",vir:"4.8",img:"https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?auto=format&fit=crop&w=1000&q=80"},
    {y:2021,make:"Mercedes-Benz",name:"C200 AMG Line",variant:"Auto · Panoramic",body:"sedan",cat:"select",km:"41 200 km",tr:"Auto",fuel:"Petrol",price:619900,tag:"Premium Select",vir:"4.8",img:"https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?auto=format&fit=crop&w=1000&q=80"},
    {y:2020,make:"Ford",name:"Ranger Wildtrak 2.0",variant:"Bi-Turbo 4×4 Auto",body:"bakkie",cat:"select",km:"72 000 km",tr:"Auto",fuel:"Diesel",price:489900,tag:"Premium Select",vir:"4.6",img:"https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&w=1000&q=80"},
    {y:2025,make:"Hyundai",name:"Grand i10 1.0 Motion",variant:"Hatch",body:"hatch",cat:"used",km:"11 136 km",tr:"Manual",fuel:"Petrol",price:219900,tag:"Premium Used",vir:"4.8",img:"https://images.unsplash.com/photo-1502877338535-766e1452684a?auto=format&fit=crop&w=1000&q=80"},
    {y:2016,make:"Toyota",name:"Corolla 1.6 Esteem",variant:"Sedan",body:"sedan",cat:"used",km:"91 906 km",tr:"Manual",fuel:"Petrol",price:179900,tag:"Premium Used",vir:"4.5",img:"https://images.unsplash.com/photo-1621007947382-bb3c3994e3fb?auto=format&fit=crop&w=1000&q=80"}
  ];
  ...
  return { WA, MOCK, fmtR, monthly, mapApi, renderCards, loadStock, observeAll, initChrome, initChat };
})();
