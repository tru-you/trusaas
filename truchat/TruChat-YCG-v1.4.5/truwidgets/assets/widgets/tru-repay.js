...
(function () {
  ...
  var VARS = [
    ...
    cfg.theme === "light" ? [
      "--tr-glass:rgba(251,248,243,.42);--tr-border:rgba(255,255,255,.55);",
      "--tr-text:#0E1A26;--tr-muted:rgba(14,26,38,.58);--tr-faint:rgba(14,26,38,.42);",
      "--tr-surface:rgba(251,248,243,.55);--tr-err:#B91C1C;",
      "--tr-fill:rgba(14,26,38,.04);--tr-fill-2:rgba(14,26,38,.07);",
      "--tr-hair:rgba(14,26,38,.09);--tr-edge:rgba(14,26,38,.14);",
      "--tr-thumb:var(--tr-signal);",
      "--tr-toggle-bg:rgba(255,255,255,.38);--tr-head-bg:linear-gradient(135deg,rgba(7,135,154,.14),rgba(93,233,212,.10));--tr-head-fg:var(--tr-text);"
  ...
  function inheritHostStyles() {
    try {
      ...
      if (isLightHost && cfg.theme !== "light") {
        cfg.theme = "light";
        extra += [
          "--tr-glass:rgba(251,248,243,.48);--tr-border:rgba(255,255,255,.55);",
          "--tr-text:#0E1A26;--tr-muted:rgba(14,26,38,.58);--tr-faint:rgba(14,26,38,.42);",
          "--tr-surface:rgba(251,248,243,.55);",
          "--tr-fill:rgba(14,26,38,.04);--tr-fill-2:rgba(14,26,38,.07);",
          "--tr-hair:rgba(14,26,38,.09);--tr-edge:rgba(14,26,38,.14);",
          "--tr-thumb:var(--tr-signal);",
          "--tr-toggle-bg:rgba(255,255,255,.38);--tr-head-bg:linear-gradient(135deg,rgba(7,135,154,.14),rgba(93,233,212,.10));--tr-head-fg:var(--tr-text);",
  ...
  function mount() {
    ...
    var style = document.createElement("style"); style.textContent = CSS + inheritHostStyles(); shadow.appendChild(style);
