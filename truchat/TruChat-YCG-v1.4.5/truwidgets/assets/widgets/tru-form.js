  ...
  function inheritHostStyles() {
    try {
      ...
      if (isLightHost && cfg.theme !== "light") {
        cfg.theme = "light";
        extra += [
          "--tf-glass:rgba(251,248,243,.82);--tf-border:rgba(255,255,255,.55);",
          "--tf-text:#0E1A26;--tf-muted:rgba(14,26,38,.58);",
          "--tf-surface:rgba(251,248,243,.55);--tf-ink:#0E1A26;",
          "--tf-fill:rgba(14,26,38,.04);--tf-fill-2:rgba(14,26,38,.07);",
        ].join("");
      }
      return extra;
    } catch (e) { return ""; }
