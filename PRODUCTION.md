...
**Product domain:** [https://premium.tru-saas.com](https://premium.tru-saas.com) · **app** / **lens** subdomains (see `DEPLOY.md`).  
...
- [ ] TruLens on HTTPS → `https://lens.tru-saas.com` (Render free web)
- [ ] Flow Premium on HTTPS → `https://premium.tru-saas.com` (Render free web)
- [ ] Landing static → `https://premium.tru-saas.com` (Render static or Cloudflare Pages free)
- [ ] `TRUFLOW_DMS_URL=https://premium.tru-saas.com` on Lens
