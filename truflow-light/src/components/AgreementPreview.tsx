  ...
  return (
    <div className="card mt-6">
      <div className="card-header flex justify-between items-center px-4 py-3 border-b border-[rgba(126,164,214,0.1)]">
        <h3 className="font-semibold text-sm">Active Binding Contract Preview</h3>
        <button
          onClick={handlePrint}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
        ...
        <div className="lg:col-span-2">
          <div className="bg-[#0B0F17] text-[#1a1a2e] rounded-xl p-8 max-w-[800px] mx-auto shadow-xl font-sans relative overflow-hidden" id="printableAgreementFrame">
            ...
            {/* Pricing Summary */}
            <div className="grid grid-cols-2 gap-4 mb-6 text-xs text-gray-800 bg-gray-50 border border-gray-200 rounded-lg p-4">
              <div>
              ...
              <div>
                <span className="text-gray-400 font-medium text-sm font-semibold">Total Cost (Incl VAT):</span>{" "}
                <span className="font-bold text-gray-950 font-mono text-sm">{formatZAR(agreement.purchasePrice)}</span>
              </div>
            </div>
            ...
            <div className="text-[13px] text-gray-600 border border-gray-200 rounded-lg p-4 bg-gray-50 h-28 overflow-y-auto mb-6 line-height-relaxed select-none">
              {agreement.type === "Offer to Purchase" ? (
                <>
                  ...
                  <div className="font-bold text-gray-900 mt-3 mb-1.5">2. FINANCING CONDITION SUSPENSIVE:</div>
                  ...
                  <div className="font-bold text-gray-900 mt-3 mb-1.5">3. POPI ACT & CREDIT BUREAU DISCLOSURE:</div>
                ...
                <>
                  ...
                  <div className="font-bold text-gray-900 mt-3 mb-1.5">3. COMPLIANCE & POPI STATUTE:</div>
          ...
          {agreement.status === "Pending Signature" ? (
            <div className="flex flex-col gap-3">
              <div className="flex bg-[#0B0F17]/5 rounded-lg p-0.5 border border-white/5">
                <button
                  ...
                  className={`flex-1 text-center py-1 text-[13px] font-bold rounded-md transition-all ${
                    signMode === "draw" ? "bg-[#4FE3DC] text-[#E8EAE6]" : "text-[rgba(232,234,230,0.72)] hover:text-[#E8EAE6]"
                  }`}
                >
                  Draw Signature
                </button>
                <button
                  ...
                  className={`flex-1 text-center py-1 text-[13px] font-bold rounded-md transition-all ${
                    signMode === "type" ? "bg-[#4FE3DC] text-[#E8EAE6]" : "text-[rgba(232,234,230,0.72)] hover:text-[#E8EAE6]"
                  }`}
                >
                  Type E-Sign
                </button>
              ...
              {signMode === "draw" ? (
                ...
                <div className="flex flex-col gap-2">
                  <input
                    ...
                    className="w-full px-3 py-2 bg-[#0B0F17]/5 border border-white/10 rounded-lg text-xs text-[#E8EAE6] outline-none focus:border-[#4FE3DC]"
                  />
              ...
              <button
                ...
                disabled={submitting}
                className="w-full py-2.5 bg-gradient-to-r from-[#4ADE9B] to-[#2DA056] text-[#E8EAE6] hover:brightness-110 active:scale-95 transition-all text-xs font-bold rounded-lg flex items-center justify-center gap-1.5 shadow-lg shadow-emerald-500/10 disabled:opacity-50"
              >
            ...
            <div className="bg-[#4ADE9B]/10 border border-[#4ADE9B]/20 rounded-xl p-4 flex flex-col items-center justify-center gap-3 py-6">
              ...
              <div className="text-center">
                <h5 className="text-xs font-semibold text-[#E8EAE6] tracking-normal">Deed fully executed</h5>
