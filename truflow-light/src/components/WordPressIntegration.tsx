            ...
            <div className="card-body p-4 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <div className="flex justify-between items-center">
                  <span className="text-[13px] text-[#E8EAE6] font-bold">Method A: WordPress Shortcode</span>
              ...
              <div className="flex flex-col gap-1.5 border-t border-white/5 pt-4">
                <span className="text-[13px] text-[#E8EAE6] font-bold">Method B: Raw HTML SDK Code (For non-WP Sites)</span>
              ...
              <div className="flex flex-col gap-1.5 border-t border-white/5 pt-4">
                <span className="text-[13px] text-[#E8EAE6] font-bold">Method C: Elegant iFrame Sandbox</span>
