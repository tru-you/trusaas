    ...
    <div className="fixed bottom-5 right-5 z-[1000] font-sans">
        ...
        <div className="flex flex-col w-[350px] h-[480px] bg-[#0B0F17] border border-[rgba(126,164,214,0.15)] rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-5 duration-200">
          ...
          <div className="flex justify-between items-center px-4 py-3 border-b border-[rgba(126,164,214,0.1)] bg-[linear-gradient(90deg,rgba(20,102,224,0.1),rgba(21,199,192,0.05))]">
            ...
            <button
              ...
              className="text-[rgba(232,234,230,0.72)] hover:text-[#E8EAE6] transition-colors p-1 rounded-lg hover:bg-white/5"
            >
              <X size={16} />
            </button>
          </div>
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-[#4FE3DC] hover:bg-[#4FE3DC]/90 disabled:opacity-50 text-[#E8EAE6] rounded-lg p-2 flex items-center justify-center cursor-pointer transition-all active:scale-95"
            >
              <Send size={14} />
            </button>
          </form>
      ...
      {!isOpen && (
        <button
          ...
          className="w-14 h-14 bg-[#4FE3DC] hover:bg-gradient-to-r from-[#4FE3DC] to-[#4FE3DC] text-[#E8EAE6] rounded-full flex items-center justify-center shadow-lg hover:shadow-[#4FE3DC]/30 transition-all cursor-pointer active:scale-95 group"
        >
