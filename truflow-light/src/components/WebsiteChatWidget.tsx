    ...
    <div className="fixed bottom-5 left-5 z-[1000] font-sans">
        ...
        <div className="flex flex-col w-[350px] h-[480px] bg-[#0B0F17] border border-[rgba(126,164,214,0.15)] rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-5 duration-200">
            ...
            {messages.map((m) => (
              <div
                ...
                className={`max-w-[85%] px-3 py-2 rounded-xl text-xs line-height-relaxed ${
                  m.sender === "user"
                    ? "self-end bg-[#4FE3DC] text-[#E8EAE6] rounded-br-none"
            ...
            {showLeadForm && (
              <div className="self-start bg-[#121826] border border-[#4FE3DC]/30 rounded-xl rounded-bl-none shadow-sm p-3 w-[90%] text-xs animate-in slide-in-from-left-2 text-[#E8EAE6]">
                ...
                <form onSubmit={handleLeadSubmit} className="flex flex-col gap-2">
                  ...
                  <button type="submit" className="bg-[#4FE3DC] text-[#E8EAE6] font-bold py-1.5 rounded mt-1 cursor-pointer hover:bg-[#4FE3DC]/90 transition-colors">Send to Dealer</button>
                </form>
              </div>
            )}
          ...
          >
            ...
            <button
              ...
              className="bg-[#4FE3DC] hover:bg-[#4FE3DC]/90 disabled:opacity-50 text-[#E8EAE6] rounded-full w-8 h-8 flex items-center justify-center cursor-pointer transition-all active:scale-95 animate-none"
            >
              <Send size={12} />
            </button>
          </form>
      ...
      {!isOpen && (
        <div className="relative group cursor-pointer animate-none" onClick={() => setIsOpen(true)}>
          ...
          <button className="w-14 h-14 bg-gradient-to-r from-blue-600 to-[#4FE3DC] text-[#E8EAE6] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all active:scale-95">
