      ...
      <html>
        ...
        <body style="font-family:system-ui,-apple-system,sans-serif;padding:40px;color:#1a1a2e;background:#fff">
          ...
          <div style="margin-top:24px;border-top:1px solid #ddd;padding-top:16px">
            <div style="font-size:11px;color:#666;text-transform:;letter-spacing:.05em;margin-bottom:6px">Signature</div>
            ${sigHtml}
            ...
            <table className="w-full text-xs text-left border-collapse min-w-[700px]">
              ...
              <tbody>
                {documents.map((doc) => {
                  ...
                  return (
                    <tr key={doc.id} className="border-b border-white/3 hover:bg-[#0B0F17]/1">
                      <td className="py-3 px-4 font-semibold text-[#E8EAE6] flex items-center gap-2">
        ...
        <div className="card">
          <div className="card-header border-b border-white/5 px-4 py-3 flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={() => setActiveDocId(null)} className="p-1.5 text-[rgba(232,234,230,0.72)] hover:text-[#E8EAE6] rounded hover:bg-white/5 cursor-pointer">
                <X size={14} />
              </button>
            </div>
          </div>
              ...
              {activeDoc.status === "Signed" ? (
                <div className="rounded-lg border border-[#4ADE9B]/30 bg-[#4ADE9B]/10 p-4 flex flex-col gap-3">
                  ...
                  <p className="text-[13px] text-[rgba(232,234,230,0.72)]">
                    Signed by <b className="text-[#E8EAE6]">{activeDoc.signedBy}</b> on {formatDate(activeDoc.signedAt)}
                  </p>
                </div>
              ) : (
                <div className="rounded-lg border border-white/10 bg-[#0B0F17]/40 p-4 flex flex-col gap-3">
                  ...
                  <div className="flex gap-1.5">
                    <button
                      ...
                      className={`flex-1 py-1.5 rounded-lg text-[13px] font-bold cursor-pointer ${signMode === "draw" ? "bg-[#4FE3DC] text-[#E8EAE6]" : "bg-white/5 text-[rgba(232,234,230,0.72)]"}`}
                    >
                      Draw
                    </button>
                    <button
                      onClick={() => setSignMode("type")}
                      className={`flex-1 py-1.5 rounded-lg text-[13px] font-bold cursor-pointer ${signMode === "type" ? "bg-[#4FE3DC] text-[#E8EAE6]" : "bg-white/5 text-[rgba(232,234,230,0.72)]"}`}
                    >
                      Type name
                    </button>
                  </div>
                  ...
                  {signMode === "draw" ? (
                    <>
                      ...
                      <input
                        ...
                        className="bg-[#0B0F17] border border-white/10 rounded-lg px-3 py-2 text-xs text-[#E8EAE6] placeholder-[#5a6b82] focus:outline-none focus:border-[#4FE3DC]"
                      />
                    </>
                  ) : (
                    <input
                      ...
                      className="bg-[#0B0F17] border border-white/10 rounded-lg px-3 py-3 text-sm text-[#E8EAE6] placeholder-[#5a6b82] focus:outline-none focus:border-[#4FE3DC]"
                  ...
                  <button
                    ...
                    disabled={submitting}
                    className="mt-1 py-2.5 bg-[#4ADE9B] hover:bg-[#4ADE9B]/90 text-[#E8EAE6] rounded-lg text-[13px] font-bold tracking-normal cursor-pointer disabled:opacity-50"
                  >
