    ...
    <div className="fixed bottom-5 right-5 z-[1000] font-sans">
      ...
      {!isOpen && (
        <button
          ...
          className="w-14 h-14 bg-[#4FE3DC] hover:bg-gradient-to-r from-[#4FE3DC] to-[#4FE3DC] text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-[#4FE3DC]/30 transition-all cursor-pointer active:scale-95 group"
        >
