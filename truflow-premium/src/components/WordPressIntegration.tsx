          ...
          <div className="card">
            <div className="card-header border-b border-white/5 px-4 py-3 flex justify-between items-center bg-[#0B0F17]/1">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-[13px] tracking-normal text-[#E8EAE6]">1. API Handshake Credentials</h3>
              </div>
              <span className="text-[13px] bg-[#4FE3DC]/15 text-[#4FE3DC] px-2 py-0.5 rounded font-semibold font-mono">LIVE API ACCESS</span>
            </div>
            ...
            <div className="card-body p-4 flex flex-col gap-3">
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center bg-black/45 border border-white/5 rounded-lg px-3 py-2 text-[13px] font-mono justify-between text-[#E8EAE6] select-all">
              ...
              <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-3 mt-1">
                <div>
                  ...
                  <span className="text-[13px] font-mono font-bold text-[#E8EAE6] mt-0.5 block">tru_sec_light_94285</span>
                </div>
                <div>
                  <span className="text-[13px] text-[rgba(232,234,230,0.72)]  font-semibold tracking-wider block">Showroom Site Domain</span>
                  <span className="text-[13px] font-mono text-[#4FE3DC] font-bold mt-0.5 block">www.real-cars.co.za</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card">
            <div className="card-header border-b border-white/5 px-4 py-3 flex justify-between items-center bg-[#0B0F17]/1">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-[13px] tracking-normal text-[#E8EAE6]">2. WordPress Shortcodes & HTML Widgets</h3>
              </div>
            </div>
            ...
            <div className="card-body p-4 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[13px] bg-[#0B0F17]/5 text-[rgba(232,234,230,0.72)] px-2 py-0.5 rounded">Fastest</span>
                </div>
                ...
                <div className="flex items-center bg-black/45 border border-white/5 rounded-lg px-3 py-2 text-[13px] font-mono justify-between text-[#4FE3DC]">
          ...
          <div className="card border-[#4FE3DC]/20 bg-[#4FE3DC]/2">
            <div className="card-header border-b border-[#4FE3DC]/10 px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-[13px] tracking-normal text-[#E8EAE6]">Lead Injection Webhook Tester</h3>
              </div>
            ...
            <div className="card-body p-4">
              ...
              <form onSubmit={handleTestWebhook} className="flex flex-col gap-3">
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      className="bg-black/30 border border-white/10 rounded px-3 py-2 text-[13px] text-[#E8EAE6] outline-none focus:border-[#4FE3DC]"
                    />
                  </div>
                  <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <textarea
                    ...
                    className="bg-black/30 border border-white/10 rounded px-3 py-2 text-[13px] text-[#E8EAE6] outline-none focus:border-[#4FE3DC] resize-none"
                  ></textarea>
                </div>
                ...
                <button
                  ...
                  className="w-full py-2 bg-[#4FE3DC] hover:bg-[#4FE3DC]/80 disabled:opacity-50 text-black font-semibold text-[13px] tracking-normal rounded-lg transition-all cursor-pointer flex items-center justify-center gap-2 shadow-sm mt-1"
                >
              ...
              {webhookResult && (
                <div className="mt-3 bg-black/40 border border-[#4FE3DC]/30 rounded-lg p-3 animate-in fade-in duration-150">
                  <div className="flex items-center gap-2 mb-1 text-[#4ADE9B] text-[13px] font-bold">
                    <CheckCircle size={12} /> Sync Success! CRM Lead Added
                  </div>
                  <pre className="text-[13px] font-mono text-[#E8EAE6] overflow-x-auto whitespace-pre-wrap leading-tight bg-black/20 p-2 rounded border border-white/5">
          ...
          <div className="card">
            <div className="card-header border-b border-white/5 px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-[13px] tracking-normal text-[#E8EAE6]">Master Inventory Syncer</h3>
              </div>
              <button
                type="button"
                disabled={syncing}
                onClick={runLiveInventorySync}
                className="flex items-center gap-1 text-[13px] font-semibold text-[#4FE3DC] hover:text-[#E8EAE6] transition-colors bg-[#4FE3DC]/10 border border-[#4FE3DC]/20 px-2 py-1 rounded cursor-pointer"
              >
            ...
            <div className="card-body p-4 flex flex-col gap-3">
              ...
              {/* Sync Console */}
              <div className="bg-[#06080D] border border-white/5 rounded-xl p-3 h-48 overflow-y-auto font-mono text-[13px] text-[rgba(232,234,230,0.72)] leading-relaxed flex flex-col gap-2">
                {syncLogs.length === 0 ? (
              ...
              {syncSuccess && (
                <div className="bg-[#4ADE9B]/10 border border-[#4ADE9B]/20 p-3 rounded-lg flex items-center gap-2 text-[13px] text-[#4ADE9B] font-bold">
