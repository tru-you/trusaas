...
<div id="truflow-showroom-catalog"></div>`;
  ...
  return (
    <div className="flex flex-col gap-6 animate-in fade-in duration-200 font-sans">
      <div>
        <h1 className="font-serif text-2xl font-semibold text-[color:var(--white)]">Web & WordPress Sync Desk</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 flex flex-col gap-5">
          ...
          <div className="card">
            <div className="card-header border-b border-white/5 px-4 py-3 flex justify-between items-center bg-[color:var(--glass)]">
              <div className="flex items-center gap-2">
                <Globe size={15} className="text-[color:var(--cyan)]" />
                <h3 className="font-semibold text-[13px] tracking-normal text-[color:var(--white)]">1. API Handshake Credentials</h3>
              </div>
              <span className="text-[13px] bg-[color:var(--cyan-faint)] text-[color:var(--cyan)] px-2 py-0.5 rounded font-semibold font-mono">LIVE API ACCESS</span>
            </div>
            
            <div className="card-body p-4 flex flex-col gap-3">
              <div className="flex flex-col gap-2">
                <span className="text-[13px] text-[rgba(232,234,230,0.72)]  font-semibold tracking-wider">Your Master Webhook Sync Endpoint</span>
                <div className="flex items-center bg-black/45 border border-white/5 rounded-lg px-3 py-2 text-[13px] font-mono justify-between text-[color:var(--white)] select-all">
                  <span className="truncate pr-4">{webhookUrl}</span>
                  <button
                    type="button"
                    onClick={() => handleCopy(webhookUrl, "webhook")}
                    className="text-[rgba(232,234,230,0.72)] hover:text-[color:var(--cyan)] transition-colors p-1"
                  >
                    {copiedText === "webhook" ? <Check size={14} className="text-[color:var(--cyan)]" /> : <Copy size={14} />}
                  </button>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-3 mt-1">
                <div>
                  <span className="text-[13px] text-[rgba(232,234,230,0.72)]  font-semibold tracking-wider block">API Handshake Key</span>
                  <span className="text-[13px] font-mono font-bold text-[color:var(--white)] mt-0.5 block">tru_sec_light_94285</span>
                </div>
                <div>
                  <span className="text-[13px] text-[rgba(232,234,230,0.72)]  font-semibold tracking-wider block">Showroom Site Domain</span>
                  <span className="text-[13px] font-mono text-[color:var(--cyan)] font-bold mt-0.5 block">www.real-cars.co.za</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card">
            <div className="card-header border-b border-white/5 px-4 py-3 flex justify-between items-center bg-[color:var(--glass)]">
              <div className="flex items-center gap-2">
                <Code size={15} className="text-[color:var(--cyan)]" />
                <h3 className="font-semibold text-[13px] tracking-normal text-[color:var(--white)]">2. WordPress Shortcodes & HTML Widgets</h3>
              </div>
            </div>
            ...
            <div className="card-body p-4 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-center">
                  <span className="text-[13px] text-[color:var(--white)] font-bold">Method A: WordPress Shortcode</span>
                  <span className="text-[13px] bg-[color:var(--glass)] text-[rgba(232,234,230,0.72)] px-2 py-0.5 rounded">Fastest</span>
                </div>
                ...
                <div className="flex items-center bg-black/45 border border-white/5 rounded-lg px-3 py-2 text-[13px] font-mono justify-between text-[color:var(--cyan)]">
                  ...
                  <button
                    ...
                    className="text-[rgba(232,234,230,0.72)] hover:text-[color:var(--cyan)] transition-colors p-1"
                  >
                    {copiedText === "shortcode" ? <Check size={14} className="text-[color:var(--cyan)]" /> : <Copy size={14} />}
                  </button>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2 border-t border-white/5 pt-4">
                <span className="text-[13px] text-[color:var(--white)] font-bold">Method B: Raw HTML SDK Code (For non-WP Sites)</span>
                <p className="text-[13px] text-[rgba(232,234,230,0.72)]">Step 1: Include this script inside your pages <code>&lt;head&gt;</code>:</p>
                <div className="flex items-center bg-black/45 border border-white/5 rounded-lg px-3 py-2 text-[13px] font-mono justify-between text-[rgba(232,234,230,0.72)]">
                  ...
                  <button
                    ...
                    className="text-[rgba(232,234,230,0.72)] hover:text-[color:var(--cyan)] transition-colors p-1"
                  >
                    {copiedText === "headcode" ? <Check size={14} className="text-[color:var(--cyan)]" /> : <Copy size={14} />}
                  </button>
                </div>
                ...
                <div className="flex items-center bg-black/45 border border-white/5 rounded-lg px-3 py-2 text-[13px] font-mono justify-between text-[rgba(232,234,230,0.72)]">
                  ...
                  <button
                    ...
                    className="text-[rgba(232,234,230,0.72)] hover:text-[color:var(--cyan)] transition-colors p-1"
                  >
                    {copiedText === "embedcode" ? <Check size={14} className="text-[color:var(--cyan)]" /> : <Copy size={14} />}
                  </button>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2 border-t border-white/5 pt-4">
                <span className="text-[13px] text-[color:var(--white)] font-bold">Method C: Elegant iFrame Sandbox</span>
                <div className="flex items-center bg-black/45 border border-white/5 rounded-lg px-3 py-2 text-[13px] font-mono justify-between text-gray-400">
                  ...
                  <button
                    ...
                    className="text-[rgba(232,234,230,0.72)] hover:text-[color:var(--cyan)] transition-colors p-1"
                  >
                    {copiedText === "iframe" ? <Check size={14} className="text-[color:var(--cyan)]" /> : <Copy size={14} />}
                  </button>
                </div>
              </div>
        ...
        <div className="lg:col-span-5 flex flex-col gap-5">
          ...
          <div className="card border-[color:var(--cyan-faint)] bg-[color:var(--cyan-faint)]">
            <div className="card-header border-b border-[color:var(--cyan-faint)] px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Sparkles size={14} className="text-[color:var(--cyan)]" />
                <h3 className="font-semibold text-[13px] tracking-normal text-[color:var(--white)]">Lead Injection Webhook Tester</h3>
              </div>
              <Wifi size={14} className="text-[color:var(--cyan)] animate-pulse" />
            </div>
            ...
            <div className="card-body p-4">
              ...
              <form onSubmit={handleTestWebhook} className="flex flex-col gap-3">
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex flex-col gap-1">
                    <span className="text-[13px] text-[rgba(232,234,230,0.72)]  font-bold">First Name *</span>
                    <input
                      required
                      type="text"
                      ...
                      className="bg-black/30 border border-white/10 rounded px-3 py-2 text-[13px] text-[color:var(--white)] outline-none focus:border-[color:var(--cyan)]"
                    />
                  </div>
                  <div className="flex flex-col gap-1">
                    <span className="text-[13px] text-[rgba(232,234,230,0.72)]  font-bold">Last Name</span>
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex flex-col gap-1">
                    <span className="text-[13px] text-[rgba(232,234,230,0.72)]  font-bold">Phone (WhatsApp) *</span>
                    <input
                      required
                      type="tel"
                  ...
                  <div className="flex flex-col gap-1">
                    <span className="text-[13px] text-[rgba(232,234,230,0.72)]  font-bold">Email</span>
                    <input
                      type="email"
                ...
                <div className="flex flex-col gap-1">
                  <span className="text-[13px] text-[rgba(232,234,230,0.72)]  font-bold">Lead Message / Notes</span>
                  <textarea
                    rows={2}
                    placeholder="Inquiry comments..."
                    value={testLead.notes}
                    onChange={(e) => setTestLead({ ...testLead, notes: e.target.value })}
                    className="bg-black/30 border border-white/10 rounded px-3 py-2 text-[13px] text-[color:var(--white)] outline-none focus:border-[color:var(--cyan)] resize-none"
                  ></textarea>
                </div>
                ...
                <button
                  ...
                  className="w-full py-2 bg-[color:var(--cyan)] hover:bg-[color:var(--cyan-soft)] disabled:opacity-50 text-black font-semibold text-[13px] tracking-normal rounded-lg transition-all cursor-pointer flex items-center justify-center gap-2 shadow-sm mt-1"
                >
              ...
              {webhookResult && (
                <div className="mt-3 bg-black/40 border border-[color:var(--cyan-soft)] rounded-lg p-3 animate-in fade-in duration-150">
                  <div className="flex items-center gap-2 mb-1 text-[color:var(--cyan)] text-[13px] font-bold">
                    <CheckCircle size={12} /> Sync Success! CRM Lead Added
                  </div>
                  <pre className="text-[13px] font-mono text-[color:var(--white)] overflow-x-auto whitespace-pre-wrap leading-tight bg-black/20 p-2 rounded border border-white/5">
          ...
          <div className="card">
            <div className="card-header border-b border-white/5 px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Database size={15} className="text-[color:var(--cyan)]" />
                <h3 className="font-semibold text-[13px] tracking-normal text-[color:var(--white)]">Master Inventory Syncer</h3>
              </div>
              <button
                type="button"
                disabled={syncing}
                onClick={runLiveInventorySync}
                className="flex items-center gap-1 text-[13px] font-semibold text-[color:var(--cyan)] hover:text-[color:var(--white)] transition-colors bg-[color:var(--cyan-faint)] border border-[color:var(--cyan-faint)] px-2 py-1 rounded cursor-pointer"
              >
            ...
            <div className="card-body p-4 flex flex-col gap-3">
              ...
              {/* Sync Console */}
              <div className="bg-[color:var(--ink)] border border-white/5 rounded-xl p-3 h-48 overflow-y-auto font-mono text-[13px] text-[rgba(232,234,230,0.72)] leading-relaxed flex flex-col gap-2">
                {syncLogs.length === 0 ? (
              ...
              {syncSuccess && (
                <div className="bg-[color:var(--cyan-faint)] border border-[color:var(--cyan-faint)] p-3 rounded-lg flex items-center gap-2 text-[13px] text-[color:var(--cyan)] font-bold">
