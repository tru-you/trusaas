  ...
  return (
    <div id="image-editor-container" className="flex flex-col h-full bg-neutral-900 text-white overflow-hidden relative">
      ...
      <div className="bg-neutral-950 px-4 py-3 flex items-center justify-between border-b border-neutral-850 z-20 shrink-0 shadow-md">
        ...
        <div>
          <p className="text-[10px] uppercase font-bold tracking-widest text-indigo-400">Backdrop Removal & Enhancement</p>
          <p className="text-[11px] text-neutral-300 font-semibold truncate max-w-[200px]">
            Studio Finisher Mode
          </p>
        </div>
        ...
        <button
          ...
          className="px-2.5 py-1 bg-emerald-600 hover:bg-emerald-500 rounded-lg text-[10px] font-bold text-white flex items-center gap-1 cursor-pointer transition-colors"
        >
      ...
      <div className="flex-1 overflow-y-auto pb-4 space-y-4">
        ...
        {/* Bottom Download/Export actions */}
        <div className="px-4">
          <button
