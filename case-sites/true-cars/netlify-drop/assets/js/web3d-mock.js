/* ============================================================
   TRUECAR SA — TruSaaS Tru3D mock player
...
(function () {
  ...
  /**
   * Mount Tru3D player into container (replaces 360 spin).
  ...
  TCSA.mountWeb3D = function (container, pkgOrVehicle) {
    ...
    container.innerHTML = `
      <div class="w3d-root">
        <div class="w3d-stage" id="w3dStage">
          ...
          <img class="w3d-media" id="w3dMedia" alt="Tru3D spin" draggable="false" />
          <div class="w3d-tags" id="w3dTags"></div>
          <div class="w3d-pop" id="w3dPop"></div>
          <div class="w3d-badge">Tru3D</div>
          <div class="w3d-hint" id="w3dHint">Drag to orbit · tap pins for damage</div>
          ${pkg.mock ? '<div class="w3d-mockpill">Tru3D mock package</div>' : ""}
        </div>
    ...
    else container.innerHTML = '<div class="w3d-err">No Tru3D frames in package</div>';
  ...
  TCSA.buildHondaOrbitPackage = function (vehicle) {
    ...
    return {
      ...
      vehicle: {
        ...
        make: v.make || "Honda",
        model: v.model || "Civic",
        trim: v.variant || "Tru3D demo orbit",
        colour: v.colour || "",
      },
      frames: frames,
      damageTags: [
