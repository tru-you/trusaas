...
TCSA.chat = {
  ...
  greet(){
    ...
    const g={
      en:{ msg:`Sawubona / Molo / Hi there! 👋 I'm <b>TruChat</b>, your True-Cars SA assistant — always here to help.<br><br>I can <b>find your perfect car</b>, work out <b>monthly finance</b>, get a <b>free trade-in value</b>, explain our <b>Tru3D + VIR</b>, or tell you about our <b>free countrywide delivery</b>. What would you like to do?`,
  ...
  respond(text){
    ...
    if(/truecars|platform|modules|dms|system|technology behind/i.test(t)) return this.botThen(()=>{
      ...
      this.quick(['Show me the Tru3D + VIR','Book a live viewing','Find me a car']);
    });
  ...
  stock(f){
    ...
    this.botThen(()=>{
      ...
      this.say(`Excellent taste! Here are some ${label} — all with a full Tru3D + VIR inspection and <b>free nationwide delivery</b>:`);
      list.forEach(v=>{
  ...
  vir(){ this.botThen(()=>{ this.say(`🔍 <b>VIR — Verified Inspection Report</b><br>Every True-Cars SA vehicle is independently inspected and scored out of 100. The full report covers:`); this.say(`• <b>360° exterior spin</b> — drag to rotate the car, tap any flagged mark to see the close-up photo and description<br>• <b>Damage hotspots</b> — every scratch, scuff and dent documented with GPS-tagged photos<br>• <b>Mechanical checklist</b> — service history, fluids, tyres, brakes, test drive notes<br>• <b>VIR score / 100</b> — so you can compare vehicles at a glance with total confidence`); this.say(`Would you like me to open a live Tru3D + VIR example for you?`); this.quick(['Show me a 360° car','Book a live viewing','Find me a car']); }); },
...
TCSA.openAiCall = function(){
  ...
  const script = [
    ...
    { who:'ai',   t:"Perfect — sending now, with Tru3D + VIRs, TruPrice benchmarks and finance calculators. Anything else?", delay: 1400 },
