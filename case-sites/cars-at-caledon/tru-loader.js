...
/* DEPLOY-ADAPTED COPY — do NOT blind-copy canonical over this file.
   Every widget sits FLAT in this site root, not in packages/<name>/.
   Canonical resolves "tru-form/tru-form.js"; here that 404s and every
   widget silently fails to mount. The booking widget is coc-book.js on
   this site, not tru-book.js. Port canonical changes by hand. */
  ...
  function loadChatStack(onComplete) {
    ...
    var configUrl = getScriptUrl("truchat/coc/config.js");
  ...
  function boot() {
    ...
    if (wanted.indexOf("book") !== -1 || wanted.indexOf("tru-book") !== -1) {
      var bookSrc = getScriptUrl("coc-book.js");
