/* Caledon Booking — one calendar for every appointment on the site.
...
(function () {
  ...
  var WA = "27618759389";
  var ADDRESS = "Cars on Caledon, 257 Caledon Street, Kariega";
  ...
  var MODES = {
    showroom: {
      ...
      dur: 60,
      ev: "Showroom visit — Cars on Caledon",
      loc: ADDRESS
    },
    live: {
      label: "Live video",
      ...
      dur: 30,
      ev: "Live video viewing — Cars on Caledon",
    ...
    tradein: {
      ...
      dur: 30,
      ev: "TruValue remote trade-in — Cars on Caledon",
      loc: "Live video call (link sent by WhatsApp)"
    }
  };
  ...
  function paint() {
    ...
    bg.innerHTML = '<div class="vd-booking">'
      ...
      + '<img src="coc-badge.jpg" alt="" style="width:34px;height:34px;border-radius:9px;object-fit:cover;flex-shrink:0">'
  ...
  function ics(name) {
    ...
    var desc = [
      ...
      "Booked by: " + name,
      "Cars on Caledon · +27 61 875 9389"
    ].filter(Boolean).join("\\n");
    return [
  ...
  function confirm() {
    ...
    var text = [
      "Hi Cars on Caledon — I'd like to book a " + m.label.toLowerCase() + ".",
      "",
      "When: " + when,
