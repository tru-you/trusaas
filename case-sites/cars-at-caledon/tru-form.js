...
(function () {
  ...
  var CSS = [
    ...
    "box-shadow:0 12px 36px -10px rgba(0,0,0,.55),0 0 24px -8px rgb(var(--tf-signal-rgb)/.35),inset 0 1px 0 rgba(255,255,255,.1);",
    ...
    "box-shadow:0 18px 40px -10px rgb(var(--tf-signal-rgb)/.4),0 0 32px -6px rgb(var(--tf-blue-rgb)/.3),inset 0 1px 0 rgba(255,255,255,.14)}",
    ...
    "box-shadow:0 28px 70px -20px rgba(0,0,0,.65),0 0 40px -16px rgb(var(--tf-signal-rgb)/.2),inset 0 1px 0 rgba(255,255,255,.1)}",
    ...
    /* section dividers */
    ".tf-section{margin:18px 0 12px;padding-top:14px;border-top:1px solid rgba(255,255,255,.08)}",
    ...
    "border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.05);color:var(--tf-muted);",
    ...
    ".tf-btn-ghost:hover{background:rgba(255,255,255,.1)}",
    ...
    /* footer */
    ".tf-foot{padding:8px 14px 10px;border-top:1px solid rgba(255,255,255,.08);flex-shrink:0;",
