...
(function () {
  ...
  TCSA.injectTrustRow = function (parent) {
    ...
    row.innerHTML =
      "<span>TruOrbit + VIR</span><span>TruPrice</span><span>TruChat</span><span>Nationwide delivery</span>";
  ...
  function injectDemoBar() {
    ...
    bar.innerHTML =
      ...
      '<span class="db-msg db-full">This whole dealership is powered by <b>TruDealer</b> — yours could look like this.</span>' +
      '<span class="db-msg db-short">Powered by <b>TruDealer</b></span>' +
    ...
    var MSGS = [
      { f: 'This whole dealership is powered by <b>TruDealer</b> — yours could look like this.', s: 'Powered by <b>TruDealer</b>' },
  ...
  var LENS_SPOTS = [
    ...
    { sel: "#homeWeb3d", name: "TruOrbit", desc: "360° orbit and damage pins built from ordinary yard photos." },
  ...
  /* Route all "I'm a dealer" / "Dealer stack" / "Dealer console"
     links to the canonical TruDealer app. Runs once at boot and
     again on late DOM inserts (see repeated ticks below). */
  var TRUDEALER_URL = "https://trudealer.true-saas.com";
  TCSA.TRUDEALER_URL = TRUDEALER_URL;
  function rewriteDealerLinks(root) {
    var scope = root || document;
    var sel = 'a[href$="dealers.html"], a[href$="dealers.html/"], a[href$="portal.html"], a[href$="dealers"], a[href*="dealers.html?"], a[href*="portal.html?"]';
    scope.querySelectorAll(sel).forEach(function (a) {
      if (a.dataset.trudealer === "1") return;
      a.dataset.trudealer = "1";
      a.setAttribute("href", TRUDEALER_URL);
      a.setAttribute("rel", "noopener");
      a.setAttribute("target", "_blank");
    });
  }
  TCSA.rewriteDealerLinks = rewriteDealerLinks;
