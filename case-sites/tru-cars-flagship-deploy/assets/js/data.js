...
TCSA.vehicles = [
  ...
  { id:'jeep-grandcherokee-23', make:'Jeep', model:'Grand Cherokee', variant:'3.6 4x4 Overland', year:2023,
    ...
    tags:['TruOrbit','VIR','LVS'], featured:true,
  ...
  { id:'toyota-corollacross-gr-23a', make:'Toyota', model:'Corolla Cross', variant:'1.8 GR-Sport', year:2023,
    ...
    tags:['TruOrbit','VIR'], featured:true,
  ...
  { id:'toyota-corollacross-gr-23b', make:'Toyota', model:'Corolla Cross', variant:'1.8 GR-Sport', year:2023,
    ...
    tags:['TruOrbit','VIR'], featured:false,
  ...
  { id:'rrcullinan-19', make:'Rolls-Royce', model:'Cullinan', variant:'6.7 V12', year:2019,
    ...
    badges:[{t:'Premium Select',c:'gold'}], vir:98, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:true,
  ...
  { id:'ferrari-purosangue-26', make:'Ferrari', model:'Purosangue', variant:'V12 AWD', year:2026,
    ...
    badges:[{t:'Premium Select',c:'gold'},{t:'Demo',c:'hot'}], vir:99, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:true,
  ...
  { id:'rrwraith-blackbadge-17', make:'Rolls-Royce', model:'Wraith', variant:'Black Badge', year:2017,
    ...
    badges:[{t:'Premium Select',c:'gold'}], vir:96, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:true,
  ...
  { id:'gwagen-g63-26a', make:'Mercedes-AMG', model:'G 63', variant:'4.0 V8 BiTurbo', year:2026,
    ...
    badges:[{t:'Premium Select',c:'gold'},{t:'Near New',c:'hot'}], vir:99, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:true,
  ...
  { id:'gwagen-g63-26b', make:'Mercedes-AMG', model:'G 63', variant:'4.0 V8 BiTurbo', year:2026,
    ...
    badges:[{t:'Premium Select',c:'gold'},{t:'Near New',c:'hot'}], vir:99, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:false,
  ...
  { id:'gwagen-g63-19', make:'Mercedes-AMG', model:'G 63', variant:'4.0 V8 BiTurbo', year:2019,
    ...
    badges:[{t:'Premium Select',c:'gold'}], vir:97, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:false,
  ...
  { id:'rangerover-d350-23', make:'Land Rover', model:'Range Rover', variant:'D350 HSE', year:2023,
    ...
    badges:[{t:'Premium Select',c:'gold'}], vir:94, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:false,
  ...
  { id:'astonmartin-db11-18', make:'Aston Martin', model:'DB11', variant:'V12 Coupe', year:2018,
    ...
    badges:[{t:'Premium Select',c:'gold'}], vir:96, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:false,
  ...
  { id:'bmw-m4-comp-23', make:'BMW', model:'M4 Competition', variant:'xDrive Coupe', year:2023,
    ...
    badges:[{t:'Premium Select',c:'gold'}], vir:95, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:false,
  ...
  { id:'bentley-continental-gt-15', make:'Bentley', model:'Continental GT', variant:'V8 Coupe', year:2015,
    ...
    badges:[{t:'Premium Select',c:'gold'}], vir:91, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:false,
  ...
  { id:'mercedesbenz-s500-coupe-16', make:'Mercedes-Benz', model:'S 500 Coupé', variant:'AMG Line', year:2016,
    ...
    badges:[{t:'Premium Select',c:'gold'}], vir:90, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:false,
  ...
  { id:'porsche-cayenne-s-19', make:'Porsche', model:'Cayenne S', variant:'2.9 V6 Turbo PDK', year:2019,
    ...
    badges:[{t:'Premium Select',c:'gold'}], vir:89, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:false,
  ...
  { id:'bmw-m3-comp-23', make:'BMW', model:'M3 Competition', variant:'xDrive Sedan', year:2023,
    ...
    badges:[{t:'Premium Select',c:'gold'},{t:'Great Price',c:'good'}], vir:96, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:false,
  ...
  { id:'amg-glc63s-19', make:'Mercedes-AMG', model:'GLC 63 S', variant:'4Matic+ AMG', year:2019,
    ...
    badges:[{t:'Premium Select',c:'gold'},{t:'Great Price',c:'good'}], vir:93, lvs:true, premium:true, tags:['TruOrbit','VIR','LVS'], featured:false,
...
TCSA.vcard = function(v){
  ...
  const img = v.img
    ? `<img src="${v.img}" alt="${v.year} ${v.make} ${v.model}" loading="lazy" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
