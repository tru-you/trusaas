 ...
 * (TRUECARS_TRUCHAT_CONFIG or RAY_TRUCHAT_CONFIG). No dealer-specific
 * branding is hardcoded here.
 */
(function () {
  "use strict";
  ...
  function boot() {
    ...
    var CFG = window.TRUECARS_TRUCHAT_CONFIG || window.RAY_TRUCHAT_CONFIG || null;
    if (!CFG) {
    ...
    style.textContent = [
      ...
      "#tc-fab .tc-fab-ico{font-size:20px;line-height:1}",
      ...
      "@media(max-width:640px){#tc-panel{left:10px;right:10px;width:auto;height:min(70vh,520px);",
      "border-radius:20px;transform-origin:bottom right}",
      "#tc-fab{width:48px;height:48px}",
      "#tc-fab .tc-fab-img{transform:scale(1.12)}",
      "#tc-fab .tc-ring,#tc-fab .tc-ring2{inset:-5px}",
