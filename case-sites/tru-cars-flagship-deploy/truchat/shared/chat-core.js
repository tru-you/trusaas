...
(function (root) {
  ...
  function injectCss() {
    ...
    s.textContent = [
      ...
      "--tc-hair:rgba(255,255,255,.10);--tc-edge:rgba(255,255,255,.18);--tc-fill-2:rgba(255,255,255,.28);--tc-inset:rgba(0,0,0,.35);",
      "--tc-shell-shadow:0 28px 80px -24px rgba(0,0,0,.75),0 0 0 1px color-mix(in srgb,var(--tc-red) 8%,transparent),inset 0 1px 0 var(--tc-hair);",
      "--tc-bot-bg:rgba(20,22,32,.9);",
      "--tc-pill-edge:color-mix(in srgb,var(--tc-red) 30%,transparent);",
      ...
      "background:var(--tc-shell-bg);backdrop-filter:blur(24px) saturate(1.6);-webkit-backdrop-filter:blur(24px) saturate(1.6);",
      "border:1px solid var(--tc-edge);border-radius:20px;overflow:hidden;",
      "box-shadow:var(--tc-shell-shadow);",
      ...
      "background:radial-gradient(ellipse 90% 50% at 50% -10%,var(--tc-glow),transparent 55%),",
      ...
      "background:linear-gradient(180deg,var(--tc-hair),transparent);",
      ...
      "border:1.5px solid color-mix(in srgb,var(--tc-red) 45%,transparent);animation:tcRing 2.4s ease-out infinite}",
      ...
      "box-shadow:0 8px 20px -6px color-mix(in srgb,var(--tc-red) 65%,transparent);overflow:hidden}",
      ...
      ".tc-name em{font-style:normal;background:linear-gradient(90deg,var(--tc-text) 20%,var(--tc-red) 100%);",
      ...
      ".tc-iconbtn{border:1px solid var(--tc-hair);background:var(--tc-hair);",
      ...
      ".tc-iconbtn:hover{color:#fff;background:var(--tc-hair);border-color:var(--tc-edge);transform:scale(1.08)}",
      ...
      ".tc-history::-webkit-scrollbar-thumb{background:var(--tc-edge);border-radius:99px}",

      /* messages */
      ".tc-msg{max-width:92%;padding:12px 14px;border-radius:16px;font-size:13.5px;line-height:1.55;word-wrap:break-word}",
      ".tc-msg.bot{align-self:flex-start;background:var(--tc-bot-bg);border:1px solid var(--tc-border);",
      "border-bottom-left-radius:6px;box-shadow:0 4px 16px -8px rgba(0,0,0,.4);",
      "animation:tcMsgIn .42s var(--tc-ease) both}",
      ".tc-msg.user{align-self:flex-end;background:var(--tc-user);",
      "border:1px solid color-mix(in srgb,var(--tc-red) 40%,transparent);border-bottom-right-radius:6px;",
      "box-shadow:0 6px 18px -10px color-mix(in srgb,var(--tc-red) 50%,transparent);animation:tcMsgUser .38s var(--tc-ease) both}",
      ".tc-msg strong{color:var(--tc-strong);font-weight:700}",
      ".tc-msg a{color:var(--tc-red)}",
      ...
      "background:var(--tc-hair);border:1px solid var(--tc-edge);color:#fff;",
      ...
      "background:var(--tc-edge);box-shadow:0 8px 18px -10px var(--tc-edge)}",
      ...
      "border:1px solid var(--tc-hair);border-radius:14px;",
      ...
      ".tc-car:hover{border-color:color-mix(in srgb,var(--tc-red) 40%,transparent);transform:translateY(-2px);",
      "box-shadow:0 12px 28px -14px color-mix(in srgb,var(--tc-red) 35%,transparent)}",
      ".tc-car::after{content:'';position:absolute;top:0;left:0;width:40%;height:100%;",
      "background:linear-gradient(90deg,transparent,var(--tc-hair),transparent);",
      ...
      "box-shadow:0 6px 16px -8px color-mix(in srgb,var(--tc-red) 70%,transparent)}",
      ".tc-sec{background:var(--tc-hair);color:var(--tc-text);border:1px solid var(--tc-edge)!important}",

      /* calendar */
      ".tc-cal{background:var(--tc-inset);border:1px solid var(--tc-hair);border-radius:14px;",
      ...
      ".tc-grid button{border:1px solid var(--tc-hair);background:var(--tc-hair);color:var(--tc-text);",
      ...
      ".tc-grid button:hover{transform:scale(1.03);border-color:var(--tc-edge)}",
      ".tc-grid button.sel{border-color:var(--tc-red);background:var(--tc-user);box-shadow:0 0 0 1px var(--tc-pill-edge)}",

      /* typing */
      ".tc-typing{font-size:11px;color:var(--tc-muted);min-height:20px;padding:0 16px 6px;display:flex;align-items:center;gap:8px}",
      ".tc-typing.is-on .tc-dots{display:inline-flex;gap:4px;padding:6px 10px;background:var(--tc-hair);",
      "border:1px solid var(--tc-hair);border-radius:12px}",
      ...
      /* composer */
      ".tc-composer{display:flex;gap:8px;padding:12px 14px 14px;border-top:1px solid var(--tc-hair);",
      "background:linear-gradient(180deg,transparent,rgba(0,0,0,.25))}",
      ".tc-composer input{flex:1;border-radius:14px;border:1px solid var(--tc-hair);",
      "background:var(--tc-inset);color:var(--tc-text);padding:13px 15px;font-size:14px;outline:none;",
      "transition:border-color .2s,box-shadow .25s,background .2s}",
      ".tc-composer input::placeholder{color:var(--tc-muted)}",
      ".tc-composer input:focus{border-color:color-mix(in srgb,var(--tc-red) 55%,transparent);background:var(--tc-fill-strong);",
      "box-shadow:0 0 0 4px color-mix(in srgb,var(--tc-red) 14%,transparent)}",
      ...
      "box-shadow:0 8px 20px -8px color-mix(in srgb,var(--tc-red) 75%,transparent);",
      "transition:transform .2s var(--tc-spring),filter .15s,box-shadow .2s}",
      ".tc-composer button:hover{filter:brightness(1.1);transform:scale(1.04);box-shadow:0 10px 24px -8px color-mix(in srgb,var(--tc-red) 85%,transparent)}",
      ...
      ".tc-foot span{color:color-mix(in srgb,var(--tc-red) 70%,transparent);font-weight:700}",
      ...
      "letter-spacing:.08em;text-transform:uppercase;color:var(--tc-pill-fg);",
      "background:var(--tc-pill-bg);border:1px solid var(--tc-pill-edge);padding:5px 10px;border-radius:999px;margin-bottom:6px}",

      /* after-hours banner */
      ".tc-after-hours{align-self:center;text-align:center;padding:8px 14px;max-width:92%;margin-bottom:4px;",
      "font-size:12px;color:#8A5A0F;background:rgba(212,148,42,.10);border:1px solid rgba(212,148,42,.35);",
      "border-radius:12px;line-height:1.5;animation:tcFadeUp .5s var(--tc-ease) both}",

      /* light theme contrast rules */
      ".tc-light .tc-shell{background:#FBF8F3!important;border:1.5px solid rgba(7,136,155,.25)!important;box-shadow:0 24px 60px -15px rgba(14,26,38,.28)!important;backdrop-filter:blur(24px)!important}",
      ".tc-light .tc-msg.bot{background:#FFFFFF!important;color:#0E1A26!important;border:1px solid rgba(14,26,38,.12)!important;box-shadow:0 4px 14px rgba(14,26,38,.05)!important}",
      ".tc-light .tc-msg.bot strong{color:#07879A!important}",
      ".tc-light .tc-msg.user{background:#0E1A26!important;color:#FFFFFF!important;border:1px solid #07879A!important}",
      ".tc-light .tc-sug{color:#0E1A26!important;background:rgba(14,26,38,.07)!important;border:1px solid rgba(7,135,154,.35)!important;font-weight:700!important}",
      ".tc-light .tc-sug:hover{background:#0E1A26!important;color:#5DE9D4!important;border-color:#0E1A26!important;box-shadow:0 6px 16px rgba(14,26,38,.2)!important}",
      ".tc-light .tc-composer{background:#F4F0E8!important;border-top:1px solid rgba(14,26,38,.12)!important}",
      ".tc-light .tc-composer input{background:#FFFFFF!important;color:#0E1A26!important;border:1.5px solid rgba(14,26,38,.18)!important}",
      ".tc-light .tc-composer input::placeholder{color:rgba(14,26,38,.45)!important}",
      ".tc-light .tc-foot{color:rgba(14,26,38,.6)!important;background:#EDE7DA!important}",
      ".tc-light .tc-foot span{color:#07879A!important;font-weight:700!important}",
    ].join("");
  ...
  function mount(container, options) {
    options = options || {};
    injectCss();
    var CFG = options.config || root.TRUECARS_TRUCHAT_CONFIG || root.RAY_TRUCHAT_CONFIG || root.COC_TRUCHAT_CONFIG || {};
    ...
    /* Light/glass theme — for cream editorial sites (TruDealer brand ground).
       The default panel is near-black, which reads as a foreign object on a
       cream page. Set CFG.theme = "light" to flip the surface tokens; the
       brand colour still drives the accent in both themes. */
    if (CFG.theme === "light") {
      container.classList.add("tc-light");
      var L = {
        "--tc-bg": "#F4F0E8",
        "--tc-panel": "rgba(251,248,243,.82)",
        "--tc-border": "rgba(14,26,38,.12)",
        "--tc-text": "#0E1A26",
        "--tc-muted": "rgba(14,26,38,.55)",
        "--tc-gold": "#0E1A26",
        "--tc-gold-dim": "rgba(14,26,38,.06)",
        "--tc-shell-bg": "linear-gradient(165deg, rgba(251,248,243,.90) 0%, rgba(244,240,232,.94) 100%)",
        "--tc-bot-bg": "var(--tc-fill-2)",
        "--tc-strong": "#0E1A26",
        "--tc-glow": "transparent",
        "--tc-fill-strong": "var(--tc-fill-2)",
        "--tc-shell-shadow": "0 28px 80px -24px rgba(14,26,38,.28), 0 0 0 1px rgba(14,26,38,.10), inset 0 1px 0 var(--tc-fill-2)"
      };
      for (var k in L) container.style.setProperty(k, L[k]);
    }
    ...
    function sendToBackend(t) {
      ...
      fetch(endpoint, {
        ...
        body: JSON.stringify({
          ...
          catalog: CFG.catalog || [],
          stock: stockList,
          vehicle: bot.getSession().vehicleInterest || detectVehicleFromPage() || undefined
        }),
        ...
        .catch(function () {
          ...
          if (destroyed) return;
          setTyping(false);
          /* Seamless standard brain fallback */
          handleOut(bot.process(t));
        });
    }
