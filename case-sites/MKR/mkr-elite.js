/* MKR Elite — shortlist & compare, structured data, accessibility, back-to-top
   ...
   and the category pages (MKR.renderCards), and survives a live DMS re-render. */
(function () {
  "use strict";
  ...
  function paintDrawer() {
    ...
    if (!saved.length) {
      body.innerHTML =
        ...
        + '<small>Tap the heart on any vehicle to line it up here — up to ' + MAX + ' side by side,<br>then send the whole list to us on WhatsApp in one tap.</small>'
        + '</div>';
      return;
    }
    ...
    body.innerHTML =
      ...
      + '<a class="btn btn-wa" target="_blank" rel="noopener" href="https://wa.me/' + WA + '?text=' + encodeURIComponent(waText()) + '">WhatsApp this shortlist</a>'
  ...
  function waText() {
    return ["Hi MKR — I've shortlisted these from your site:"]
  ...
  var DEALER = {
    ...
    "@type": "AutoDealer",
    "@id": "https://mkrautosales.co.za/#dealer",
    name: "MKR Auto Sales",
    description: "Premium pre-owned vehicle dealership in Gqeberha — Premium Used, Premium Select and Premium Performance, with VAF Bridge finance, trade-ins and free nationwide delivery.",
    url: "https://mkrautosales.co.za/",
    logo: "https://mkrautosales.co.za/mkr-logo.png",
    image: "https://mkrautosales.co.za/mkr-badge.jpg",
    telephone: "+27662912809",
    priceRange: "RR",
    currenciesAccepted: "ZAR",
    areaServed: { "@type": "Country", name: "South Africa" },
    address: {
      "@type": "PostalAddress",
      streetAddress: "495 Cape Road, Westering",
  ...
  function stockSchema() {
      ...
      return {
        ...
        item: {
          ...
          offers: {
            ...
            seller: { "@id": "https://mkrautosales.co.za/#dealer" }
          }
        }
      };
    });
    jsonld("mkr-ld-stock", {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: (document.title || "MKR Auto Sales").split("—")[0].trim() + " stock",
  ...
  window.MKRElite = { open: openDrawer, close: closeDrawer, saved: function () { return saved.slice(); } };
})();
