...
window.RAY_TRUCHAT_CONFIG = {
  ...
  /**
   * Ray's personal WhatsApp — digits only, country code, no +
   * Web chat "Continue on WhatsApp" + tickets land here.
   */
  personalWhatsApp: "27834659921",
  salesWhatsApp: "27834659921",

  /** WhatsApp Business Cloud API number — later */
  waBusinessNumber: "",
