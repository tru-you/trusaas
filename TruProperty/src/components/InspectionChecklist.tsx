    ...
    <div className="flex flex-col h-full bg-white text-[#0A1420] overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-5 pb-24">
        {(DEFAULT_TEMPLATE.disclosureQuestions || []).map(section => (
          <div key={section.section}>
            <h2 className="text-[13px] font-medium text-[rgba(10,20,32,0.50)] mb-2">
              {section.section}
            </h2>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <p className="text-[12px] font-medium text-[rgba(10,20,32,0.85)] leading-snug flex-1">
                        {item.q}
                      </p>
                      {isFlagged
      ...
      <div className="shrink-0 p-3 border-t border-[rgba(10,20,32,0.06)] bg-white/95">
        <button
          ...
          disabled={saving}
          className="w-full py-3 rounded-xl bg-[#0E9D98] hover:bg-[#0BB5AF] text-white text-[13px] font-semibold flex items-center justify-center gap-2 disabled:opacity-60"
        >
          <Save size={14} />
