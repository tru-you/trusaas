...
const DISMISS_KEY = 'truestate_pwa_install_dismissed';
...
export default function PwaInstallBanner() {
  ...
  return (
    <div className="absolute bottom-3 left-2 right-2 z-[100] pointer-events-auto">
      <div className="rounded-2xl border border-[#0E9D98]/30 bg-white/95 backdrop-blur-md shadow-2xl shadow-[rgba(14,157,152,0.15)] px-3 py-3">
        <div className="flex items-start gap-3">
          <div className="mt-0.5 p-2 rounded-xl bg-[#0E9D98]/12 border border-[#0E9D98]/20 text-[#0E9D98] shrink-0">
            <Smartphone size={16} />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-[13px] font-semibold text-[#0A1420] tracking-wide ">
              Install Prop Inspect
            </p>
            ...
            {iosHelp && (
              <ol className="mt-2 text-[13px] text-[rgba(10,20,32,0.72)] space-y-1 list-decimal list-inside">
                ...
                <li>
                  Tap <b>Add</b> — open Prop Inspect from your home screen
                </li>
              </ol>
            )}
            <div className="flex gap-2 mt-2">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-2 rounded-xl tl-btn-3d bg-[#0E9D98] hover:bg-[#0BB5AF] text-white text-[13px] font-semibold tracking-normal"
              >
                <Download size={12} />
              ...
              <button
                type="button"
                onClick={dismiss}
                className="px-3 py-2 rounded-xl border border-[rgba(10,20,32,0.15)] text-[rgba(10,20,32,0.55)] text-[13px] font-bold"
                aria-label="Dismiss"
              >
                <X size={14} />
              </button>
