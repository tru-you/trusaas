...
// Named DB shared with PropLens property capture service.
const PROPINFO_DB_ID = 'ai-studio-autolenspro-7d4757ec-a059-4566-98db-d15a4840f4ec';

const app = initializeApp(firebaseConfig);
export const auth = getAuth(app);
export const firestore = getFirestore(app, PROPINFO_DB_ID);
