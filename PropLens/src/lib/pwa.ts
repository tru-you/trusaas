/** PropLens PWA helpers — install state + service worker registration */
...
export async function registerPropLensServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    ...
    console.warn('[PropLens PWA] Service worker registration failed', err);
    return null;
  }
}
