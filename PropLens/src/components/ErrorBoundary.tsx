...
/**
 * Catches render errors so one bad component doesn't take the whole FlowPMS down.
 *
  ...
  render() {
    ...
    return (
      <div className="min-h-screen bg-[#F5F4F1] text-[#0A1420] flex items-center justify-center p-6">
        <div className="max-w-md w-full flex flex-col gap-4 rounded-[18px] border border-[rgba(10,20,32,0.10)] bg-white p-6">
          <div>
            <h2 className="text-[20px] font-semibold tracking-[-0.01em]">Something went wrong</h2>
            <p className="text-[13px] text-[rgba(10,20,32,0.55)] mt-2 leading-relaxed">
          ...
          <p className="text-[13px] font-mono text-[rgba(10,20,32,0.55)] bg-[#EFEDE8] border border-[rgba(10,20,32,0.10)] rounded-lg px-3 py-2 break-words">
