...
export default function ReportPreview({ property, onBack, onVehicleUpdated }: ReportPreviewProps) {
  ...
  return (
    <div className="h-full w-full overflow-y-auto bg-[#F5F4F1] text-[#0A1420]">
      ...
      <div className="no-print bg-[#EFEDE8] border-b border-[rgba(10,20,32,0.10)]">
      ...
      {/* Action bar */}
      <div className="sticky top-0 z-50 bg-[#EFEDE8]/95 backdrop-blur border-b border-[rgba(10,20,32,0.10)] no-print">
        <div className="max-w-5xl mx-auto px-3 py-3 flex flex-wrap items-center justify-between gap-2">
          <button onClick={onBack} className="flex items-center gap-2 text-[rgba(10,20,32,0.55)] hover:text-[#0A1420] text-[16px] font-medium">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button onClick={handleCopyWa} className="flex items-center gap-1 px-3 py-2 bg-emerald-50 border border-emerald-300 rounded-lg text-[13px] font-bold text-emerald-700">
            ...
            <button onClick={exportHtml} disabled={exporting}
              ...
              className="flex items-center gap-1 px-3 py-2 bg-[rgba(10,20,32,0.05)] rounded-lg text-[13px] font-bold text-[rgba(10,20,32,0.55)] disabled:opacity-50">
              <FileText size={12} /> {exporting ? 'Embedding…' : 'HTML'}
            </button>
            <button onClick={() => window.print()} className="flex items-center gap-1 px-3 py-2 bg-[rgba(10,20,32,0.05)] rounded-lg text-[13px] font-bold text-[rgba(10,20,32,0.55)]">
              <Printer size={12} /> Print
            </button>
            <button onClick={runPdf} disabled={!!generating}
              className="flex items-center gap-1 px-3 py-2 rounded-lg text-[13px] font-bold text-white"
              style={{ background: 'linear-gradient(120deg, #0E9D98, #0B8A85)' }}>
      ...
      <div className="max-w-5xl mx-auto p-3 space-y-4">
        ...
        <div className="no-print rounded-xl border border-[rgba(10,20,32,0.10)] bg-white p-3 text-[13px]">
          <div className="flex justify-between gap-2">
            ...
            <div className="text-right text-[rgba(10,20,32,0.55)] text-[13px] max-w-[200px]">
          ...
          <div className="mt-3 pt-3 border-t border-[rgba(10,20,32,0.10)]">
            <div className="text-[12px] text-[rgba(10,20,32,0.55)] mb-2">Condition declaration</div>
              ...
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-[13px] font-bold border transition-colors disabled:opacity-40 disabled:cursor-not-allowed ${
                  conditionState === 'clear'
                    ...
                    : 'bg-[rgba(10,20,32,0.03)] border-[rgba(10,20,32,0.10)] text-[rgba(10,20,32,0.55)] hover:bg-[rgba(10,20,32,0.06)]'
                }`}
              >
                No visible damage
              </button>
            ...
            {conditionState === 'undeclared' && (
              <p className="text-[12px] text-amber-600 mt-2">
                Declare the property's condition — a listing isn't ready until this is stated.
              </p>
            )}
            {findings.length > 0 && (
              <p className="text-[12px] text-[rgba(10,20,32,0.55)] mt-2">
        ...
        <div ref={reportRef} className="tl-report">
          ...
          <div className="doc-body">
            ...
            {(() => {
              ...
              const sub =
                conditionState === 'clear'
                  ? 'Agency reports no visible damage on the captured photos.'
                  : conditionState === 'damage'
                  ? 'Visible damage tagged and shown below.'
                  : 'Condition not yet declared by the agency.';
              return (
            ...
            {/* Report details — agency & property identity */}
            ...
            <div className="card" style={{ marginTop:10 }}>
              ...
              <div className="prose">
                This report documents the <b>visual condition</b> of the property's exterior, interior rooms, systems and compliance at a single moment in time, based on photographs captured during the PropLens session.
                It is <b>not</b> a structural inspection, systems assessment, or warranty. Damage tags and condition scores reflect only what was visible
                and recorded in the photographs provided. Hidden defects, mechanical systems, and compliance certifications are outside the scope of this report.
              </div>
            </div>
