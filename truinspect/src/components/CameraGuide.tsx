      ...
      <div className="bg-neutral-900 border-b border-neutral-850 px-4 py-2 shrink-0 animate-in slide-in-from-top-2 duration-300">
        <div className="flex justify-between items-center mb-2">
          <span className="text-[13px] font-medium text-neutral-200">
            {completedSlots.length} of {DEFAULT_TEMPLATE.slots.length} captured
          </span>
          <span className="text-[13px] font-mono text-[#4FE3DC]">
            {DEFAULT_TEMPLATE.slots.length - completedSlots.length} to go
          </span>
        </div>
      ...
      <div className="bg-neutral-950 p-4 border-t border-neutral-850 space-y-4 shrink-0">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <button
            ...
            className="w-[88px] h-[88px] rounded-full flex flex-col items-center justify-center gap-1 cursor-pointer shadow-lg active:scale-[0.95] transition-all disabled:opacity-60 bg-cyan-600 hover:bg-cyan-500 text-[#06080D] border-4 border-cyan-500/30"
