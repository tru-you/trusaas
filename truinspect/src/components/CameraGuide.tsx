      ...
      <div className="capture-preview relative flex-1 min-h-0 bg-black flex flex-col justify-center overflow-hidden">
        ...
        <div className="absolute top-0 inset-x-0 z-30 px-4 pt-3 pb-6 bg-gradient-to-b from-black/75 via-black/40 to-transparent pointer-events-none">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center min-w-0 px-2">
              ...
              <p className="text-[12px] font-mono text-[#4FE3DC]">
                {completedSlots.length} / {DEFAULT_TEMPLATE.slots.length} · {DEFAULT_TEMPLATE.slots.length - completedSlots.length} to go
              </p>
            </div>
          ...
          <div className="mt-2 h-[3px] rounded-full bg-[rgba(232,234,230,0.14)] overflow-hidden">
            <div
              ...
              style={{ width: `${Math.round((completedSlots.length / Math.max(DEFAULT_TEMPLATE.slots.length, 1)) * 100)}%` }}
            />
          </div>
        </div>
        ...
        <div className="absolute inset-x-0 bottom-0 z-20 pointer-events-none px-4 pt-10 pb-3 bg-gradient-to-t from-black/75 via-black/35 to-transparent">
          <div className="flex items-center gap-2">
            <span className="text-[11px] font-mono text-[#4FE3DC]">Shot {activeSlotIndex + 1} / {DEFAULT_TEMPLATE.slots.length}</span>
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            {onOpenChecklist && (
              <button
                ...
                className="flex items-center justify-center gap-2 min-h-[44px] px-4 rounded-[12px] text-[13px] font-medium text-[rgba(232,234,230,0.72)] hover:text-[#E8EAE6] hover:bg-[rgba(232,234,230,0.06)] cursor-pointer transition-colors"
              >
