    ...
    container.innerHTML = `
      <div class="w3d-root">
        ...
        <div class="w3d-controls">
          <button type="button" class="w3d-ctrl-btn" id="w3dPrev" aria-label="Previous">‹</button>
          <button type="button" class="w3d-play-btn" id="w3dPlay">Play</button>
          <div class="w3d-scrub">
            <input id="w3dScrub" type="range" min="0" max="${Math.max(frames.length - 1, 0)}" value="0" step="1" />
          </div>
          <button type="button" class="w3d-ctrl-btn" id="w3dNext" aria-label="Next">›</button>
        </div>
        <div class="w3d-meta">
