// assets/js/index-page.js — Homepage Logic Controller for AutoLogic PE (Flagship Matched)
...
(function() {
  ...
  function renderHero(v) {
    ...
    if (eyebrowEl) eyebrowEl.innerHTML = 'Featured · <a href="https://trudealers.com" target="_blank" rel="noopener" style="color:inherit;text-decoration:none;">TruInspect VIR® ' + (v.virScore || 92) + '</a>';

    var ctaEl = document.getElementById('heroCta');
    if (ctaEl) {
      ctaEl.textContent = 'View This Vehicle';
  ...
  function renderBrandHero() {
    var titleEl = document.getElementById('heroTitle');
    if (titleEl) {
      titleEl.innerHTML = 'PRE-OWNED EXCELLENCE, <em>WHOLESALE VALUE.</em>';
    }
    var eyebrowEl = document.getElementById('heroEyebrow');
    if (eyebrowEl) {
      eyebrowEl.innerHTML = 'Newton Park, Gqeberha · <a href="https://trudealers.com" target="_blank" rel="noopener" style="color:inherit;text-decoration:none;">TruInspect VIR® Certified</a>';
    }
    var priceEl = document.getElementById('heroPrice');
    if (priceEl) {
      priceEl.innerHTML = '<a href="https://trudealers.com" target="_blank" rel="noopener" style="color:inherit;text-decoration:none;">TruInspect VIR® Scored</a>';
    }
    var kmEl = document.getElementById('heroKm');
    if (kmEl) kmEl.textContent = 'Multi-Bank Approved';
    var deltaWrap = document.getElementById('heroDeltaWrap');
    var deltaEl = document.getElementById('heroDelta');
    if (deltaEl) deltaEl.textContent = 'Same-Day Trade-Ins';
    if (deltaWrap) deltaWrap.style.display = 'inline-flex';
    var ctaEl = document.getElementById('heroCta');
    if (ctaEl) {
      ctaEl.textContent = 'Request Vehicle Sourcing';
      ctaEl.href = 'https://wa.me/27726047878?text=' + encodeURIComponent("Hi Curt & Davrin! I am looking for a specific vehicle within my budget. Can you source it for me?");
    }
  }
  ...
  function updateHomepageUI(stock) {
    ...
    if (railCount) {
      animateCount(railCount, stock.length || 0, 1200);
    }
