/**
 * TruLoader — Universal Widget Loader for AutoLogic PE
 */
(function (root) {
  "use strict";
  ...
  var globalCfg = {
    dealer: getAttr("data-dealer", "AutoLogic PE"),
    slug: getAttr("data-slug", "autologic-pe"),
    flow: getAttr("data-flow", "https://premium.trudealers.com"),
    webhook: getAttr("data-webhook", ""),
    apiKey: getAttr("data-key", "") || getAttr("data-api-key", "") || getAttr("data-dms-key", ""),
    wa: (getAttr("data-wa", "27826039334") || "").replace(/\D/g, ""),
    accent: getAttr("data-accent", "#E31B23"),
    brand: getAttr("data-brand", "AutoLogic PE"),
  ...
  function propagateDms(tag) {
    tag.setAttribute("data-currency", "R");
    tag.setAttribute("data-market", "za");
    if (globalCfg.apiKey) tag.setAttribute("data-key", globalCfg.apiKey);
  ...
  function boot() {
    ...
    if (wanted.indexOf("chat") !== -1 || wanted.indexOf("tru-chat") !== -1 || wanted.indexOf("truchat") !== -1) {
      ...
      cTag.setAttribute("data-flow", globalCfg.flow);
