/**
 * TruShare — per-vehicle sharing for AutoLogic PE
 */
(function (root) {
  "use strict";
  ...
  var cfg = {
    dealer: attr("data-dealer", "AutoLogic PE"),
  ...
  shadow.innerHTML =
    ...
    ".ts-btn:hover{background:rgba(255,255,255,.12);border-color:var(--red-primary)}" +
