...
(function () {
  ...
  var VARS = [
    ...
    "--tr-wa:#8C3D12;--tr-wa-deep:#E31B23;",
    "--tr-glass:rgba(18,24,36,.92);--tr-border:rgba(227,27,35,.32);",
    ...
    "--tr-hair:rgba(227,27,35,.2);--tr-edge:rgba(227,27,35,.35);--tr-thumb:#FAF5EE;",
    /* light/glass palette fallback */
    cfg.theme === "light" ? [
      "--tr-glass:rgba(255,255,255,.94);--tr-border:rgba(227,27,35,.22);",
      "--tr-text:#1C1917;--tr-muted:#57534E;--tr-faint:rgba(28,25,23,.42);",
      "--tr-surface:#FAF5EE;--tr-err:#B91C1C;",
      "--tr-fill:rgba(227,27,35,.04);--tr-fill-2:rgba(227,27,35,.08);",
      "--tr-hair:rgba(227,27,35,.14);--tr-edge:rgba(227,27,35,.24);",
  ...
  var CSS = [
    ...
    ".tr-btn-wa:hover{filter:brightness(1.08);transform:translateY(-2px);box-shadow:0 14px 30px -8px rgba(227,27,35,.65)}",
      ...
      '<div class="tr-panel" role="dialog" aria-modal="', isInline ? 'false' : 'true', '" aria-label="', esc(cfg.heading), '">',
        ...
        '<div class="tr-body">',
          ...
          '<div class="tr-field"><label for="tr-price">Vehicle price</label>',
            '<div class="tr-price"><span style="display:inline-flex;align-items:center;line-height:1;margin-right:2px;">', esc(cfg.cur), '</span>',
