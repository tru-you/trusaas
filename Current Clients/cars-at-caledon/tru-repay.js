...
(function () {
  ...
  var CSS = [
    ...
    isCollapsible ? [
      ...
      "background:linear-gradient(145deg,rgba(20,22,30,.82),rgba(14,16,22,.84));",
      "border:1px solid var(--tr-border);border-radius:18px;color:#fff;cursor:pointer;",
      ...
      ".tr-toggle-title{font-size:15px;font-weight:700;text-align:left;flex:1;color:#fff}",
    ...
    isInline && !isCollapsible ? "" : "#tr.is-open .tr-panel{display:flex;", isCollapsible ? "" : "opacity:1;transform:none", "}",
    "@supports(backdrop-filter:blur(1px)){.tr-panel{backdrop-filter:blur(28px) saturate(1.5)}}",

    /* header */
    ".tr-head{padding:18px 16px 14px;display:flex;align-items:center;gap:12px;background:var(--tr-grad);position:relative;overflow:hidden;flex-shrink:0}",
    ".tr-head-icon{width:42px;height:42px;border-radius:14px;background:rgba(255,255,255,.18);display:grid;place-items:center;flex-shrink:0}",
    ".tr-head-icon svg{width:22px;height:22px}",
    ".tr-head b{display:block;font-size:16px;font-weight:800;color:#fff}",
    ".tr-head span{display:block;font-size:11.5px;opacity:.85;margin-top:2px;color:rgba(255,255,255,.8)}",
    ".tr-x{margin-left:auto;width:34px;height:34px;border-radius:10px;background:rgba(255,255,255,.16);color:#fff;font-size:18px;display:grid;place-items:center}",

    ".tr-body{padding:16px;overflow-y:auto;flex:1;min-height:0}",

    /* result card */
    ".tr-result{background:linear-gradient(150deg,rgba(255,255,255,.06),rgba(255,255,255,.02));",
    ...
    ".tr-rb{display:flex;justify-content:space-between;font-size:12.5px;padding:5px 0;border-top:1px solid rgba(255,255,255,.07)}",
    ...
    ".tr-price{display:flex;align-items:center;gap:8px;border:1.5px solid rgba(255,255,255,.12);background:rgba(255,255,255,.06);border-radius:12px;padding:10px 13px}",
    ".tr-price span{font-weight:800;color:var(--tr-muted)}",
    ".tr-price input{flex:1;border:none;background:none;color:#fff;font:800 18px Inter,system-ui,sans-serif;outline:none;width:100%}",
    ...
    "input[type=range]::-moz-range-thumb{width:20px;height:20px;border-radius:50%;background:#fff;border:3px solid var(--tr-signal);cursor:pointer}",
    ...
    ".tr-capture{display:none;margin-top:6px;padding-top:14px;border-top:1px solid rgba(255,255,255,.1);animation:trIn .35s var(--tr-ease) both}",
    ...
    ".tr-inp{width:100%;padding:12px 13px;border-radius:12px;border:1.5px solid rgba(255,255,255,.12);",
    "background:rgba(255,255,255,.06);color:#fff;font:600 14px Inter,system-ui,sans-serif;outline:none;margin-bottom:10px}",
    ...
    ".tr-btn-ghost{background:rgba(255,255,255,.06);color:#fff;border:1px solid rgba(255,255,255,.14)}",
    ".tr-btn-ghost:hover{background:rgba(255,255,255,.1)}",
    ...
    ".tr-foot{padding:8px 14px 10px;border-top:1px solid rgba(255,255,255,.08);flex-shrink:0;font-size:9.5px;color:var(--tr-muted);text-align:center}",
