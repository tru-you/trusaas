...
(function () {
  ...
  var CSS = [
    ...
    "border:1px solid rgb(var(--ta-signal-rgb)/.35);color:#fff;",
    "box-shadow:0 14px 36px -10px rgba(0,0,0,.65),0 0 24px -6px rgb(var(--ta-signal-rgb)/.32),inset 0 1px 0 rgba(255,255,255,.14);",
    "backdrop-filter:blur(22px) saturate(1.7);-webkit-backdrop-filter:blur(22px) saturate(1.7);",
    "transition:transform .35s var(--ta-spring),box-shadow .35s var(--ta-ease),border-color .25s;text-align:left}",
    ...
    "#" + ID + "-root .ta-launcher:hover{transform:translateY(-4px) scale(1.02);border-color:rgb(var(--ta-signal-rgb)/.65);",
    "box-shadow:0 20px 46px -10px rgba(0,0,0,.75),0 0 32px -4px rgb(var(--ta-signal-rgb)/.45),inset 0 1px 0 rgba(255,255,255,.22)}",
    "#" + ID + "-root .ta-launcher:active{transform:scale(.97)}",
    "#" + ID + "-root .ta-ico{",
    "width:42px;height:42px;border-radius:50%;flex-shrink:0;",
    "background:var(--ta-grad);position:relative;z-index:1;",
    "display:grid;place-items:center;box-shadow:0 6px 18px -4px rgb(var(--ta-signal-rgb)/.6)}",
    ...
    "background:var(--ta-glass);backdrop-filter:blur(28px) saturate(1.8);-webkit-backdrop-filter:blur(28px) saturate(1.8);",
    "border:1px solid var(--ta-border);color:var(--ta-text);",
    "box-shadow:0 28px 70px -20px rgba(0,0,0,.65),0 0 40px -16px rgb(var(--ta-signal-rgb)/.25),inset 0 1px 0 rgba(255,255,255,.1);",
