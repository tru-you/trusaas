...
(function () {
  ...
  var VARS = [
    ...
    "--tf-ink:#0D131C;--tf-wa:#8C3D12;--tf-wa-deep:#B85B24;",
    "--tf-glass:rgba(18,24,36,.94);--tf-border:rgba(184,91,36,.32);",
    ...
    "--tf-hair:rgba(184,91,36,.2);--tf-edge:rgba(184,91,36,.35);",
    cfg.theme === "light" ? [
      "--tf-glass:rgba(255,255,255,.94);--tf-border:rgba(184,91,36,.22);",
      "--tf-text:#1C1917;--tf-muted:#57534E;--tf-faint:rgba(28,25,23,.42);",
      "--tf-surface:#FAF5EE;--tf-err:#B91C1C;",
      "--tf-fill:rgba(184,91,36,.04);--tf-fill-2:rgba(184,91,36,.08);",
      "--tf-hair:rgba(184,91,36,.14);--tf-edge:rgba(184,91,36,.24);"
    ].join("") : "",
    (function () {
  ...
  var CSS = [
    ...
    isInline
      ...
      : [
          ...
          "max-height:min(85vh,680px);border-radius:22px;overflow:hidden;",
