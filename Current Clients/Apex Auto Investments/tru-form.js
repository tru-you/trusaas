...
(function () {
  ...
  var CSS = [
    ...
    "border:1px solid rgb(var(--tf-signal-rgb)/.35);color:#fff;",
    "box-shadow:0 14px 36px -10px rgba(0,0,0,.65),0 0 24px -6px rgb(var(--tf-signal-rgb)/.32),inset 0 1px 0 rgba(255,255,255,.14);",
    "backdrop-filter:blur(22px) saturate(1.7);-webkit-backdrop-filter:blur(22px) saturate(1.7);",
    "transition:transform .35s var(--tf-spring),box-shadow .35s var(--tf-ease),border-color .25s;text-align:left}",
    ...
    ".tf-launcher:hover{transform:translateY(-4px) scale(1.02);border-color:rgb(var(--tf-signal-rgb)/.65);",
    "box-shadow:0 20px 46px -10px rgba(0,0,0,.75),0 0 32px -4px rgb(var(--tf-signal-rgb)/.45),inset 0 1px 0 rgba(255,255,255,.22)}",
    ".tf-launcher:active{transform:scale(.97)}",
    ".tf-ico{",
    "width:42px;height:42px;border-radius:50%;flex-shrink:0;",
    "background:var(--tf-grad);position:relative;z-index:1;",
    "display:grid;place-items:center;box-shadow:0 6px 18px -4px rgb(var(--tf-signal-rgb)/.6)}",
    ...
    "background:var(--tf-glass);backdrop-filter:blur(28px) saturate(1.8);-webkit-backdrop-filter:blur(28px) saturate(1.8);",
    "border:1px solid var(--tf-border);color:var(--tf-text);",
    "box-shadow:0 28px 70px -20px rgba(0,0,0,.65),0 0 40px -16px rgb(var(--tf-signal-rgb)/.25),inset 0 1px 0 rgba(255,255,255,.1)}",
